#include "stickynav-core/trajectory_generator.h"
...
namespace active_3d_planning
{
    ...
    SegmentSelector::SegmentSelector(BasePlanner &planner) : Module(planner) {}

    GeneratorUpdater::GeneratorUpdater(BasePlanner &planner) : Module(planner) {}
} // namespace active_3d_planning